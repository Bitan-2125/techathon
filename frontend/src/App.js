                      ...
                      {responses.map((response) => (
                        <div key={response.id} className="border border-gray-200 rounded-lg p-4">
                          <div className="flex justify-between items-start mb-3">
                            <h4 className="font-semibold text-gray-900">{response.donor_name}</h4>
                            <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                          ...
                          <div className="space-y-1 mb-3">
                            <p className="text-sm text-gray-600">
                              📧 <span className="font-medium">Email:</span> {response.donor_email || 'Not provided'}
                            </p>
                            {response.donor_phone && (
                              <p className="text-sm text-gray-600">
                                📞 <span className="font-medium">Phone:</span> {response.donor_phone}
                              </p>
                            )}
                          </div>
